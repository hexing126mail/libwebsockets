...
static int interrupted, ok, fail, _exp = 112;
...
main(int argc, const char **argv)
{
	...
	if (!lws_smd_register(context, NULL, LWSSMDCL_INTERACTION, smd_cb1int)) {
	...
	if (!lws_smd_register(context, NULL, LWSSMDCL_SYSTEM_STATE, smd_cb2int)) {
